...
As human authors, we would make a single change at the end of this sentence to avoid repeating the word "complexity": *"..., while CCC increased the model's complexity to capture the relationships."*
