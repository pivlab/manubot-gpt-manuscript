...
We triggered the workflow manually and used the `text-davinci-003` language model to produce one pull request (PR) per manuscript.
...
The automatic assessment of paragraphs of different sections across four manuscripts is shown in Figure @fig:llm_judge.
